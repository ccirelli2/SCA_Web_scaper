...
def insert_function_2(mydb, action, row_number, obj_name, data_obj):
    '''
...
def main_scraper_function(bsObj, mydb, Count):
    ...
    insert_function_2(mydb, action = 'create_row', row_number = Count,
    ...
    try:
        ...
        Ref_class_period_start_date_obj = datetime.strptime(Ref_class_period_start, ' %m/%d/%Y')
        insert_function_2(mydb, action='update',row_number=Count, obj_name ='Ref_class_period_start',
    ...
    try:
        ...
        insert_function_2(mydb, action='update',row_number=Count, obj_name ='Ref_class_period_end',
